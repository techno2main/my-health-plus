...
const ActiveReglagesTabContext = createContext<ReglagesTabType>("notifications");

export const useActiveReglagesTab = () => useContext(ActiveReglagesTabContext);
...
export function ReglagesTabs({ notificationsContent, synchronisationContent, securiteContent, header }: ReglagesTabsProps) {
  ...
  return (
    <ActiveReglagesTabContext.Provider value={activeTab}>
      {header}
    ...
    </ActiveReglagesTabContext.Provider>
  );
}
